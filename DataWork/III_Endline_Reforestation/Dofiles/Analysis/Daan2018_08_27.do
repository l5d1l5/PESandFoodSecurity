...
merge 1:1 region site bloc parcelle nom prenom using "DataWork\II_Baseline_Reforestation\DataSets\Intermediate\Daan_participant_survey_clean.dta", gen(merge2)
